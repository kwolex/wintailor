...
2. Скачайте `WinTailor-1.0.0-setup.exe` — установщик (или `WinTailor-1.0.0-portable.zip`, если не хотите ничего устанавливать).
...
| ⚙️ **27 настроек** | Телеметрия, реклама, виджеты, классическое контекстное меню, панель задач слева, расширения файлов, игровые оптимизации |
...
| 🤖 **Автоустановка** | Пропуск лицензии и экранов конфиденциальности, локальный пользователь, регион, часовой пояс, имя компьютера |
| 📁 **Свои файлы** | Установщики, драйверы, конфиги — окажутся в `C:\Setup` или на рабочем столе сразу после установки |
| 📊 **Отчёт после сборки** | Что удалено на самом деле, что не удалось и насколько меньше стала система |
| 💾 **Запись флешки** | Загружается и на UEFI, и на старых BIOS; большой `install.wim` делится автоматически |

Интерфейс на русском и английском, тёмная и светлая темы, пресеты настроек, горячие клавиши (F1 — список).
...
2. **Вкладка «Образ»:** укажите ISO и нажмите «Прочитать образ». Выберите редакцию — ту, на которую у вас есть лицензия (обычно Pro или Домашняя).
...
6. **Вкладка «Сборка»** → «Собрать образ». Обычно это 20–60 минут. В конце откроется отчёт.
7. **Вкладка «Флешка»:** вставьте флешку от 8 ГБ, выберите её и нажмите «Записать». Или запишите готовый ISO чем угодно другим.
...
Нашли ошибку или есть идея — откройте [issue](https://github.com/kwolex/wintailor/issues). Приложите файл отчёта `*.report.txt` (лежит рядом с собранным ISO) или текст из лога на вкладке «Сборка».
