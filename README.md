...
| ⚙️ **37 настроек** | Телеметрия, реклама, виджеты, классическое контекстное меню, тёмная тема, «Пуск» без рекомендаций, Проводник без «Главной» и «Галереи», игровые оптимизации |
...
| 🗂️ **Несколько редакций** | Например, Pro и Home в одном ISO — установщик спросит, какую ставить |
