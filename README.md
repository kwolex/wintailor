...
Нашли ошибку или есть идея — откройте [issue](https://github.com/kwolex/wintailor/issues). Приложите файл отчёта `*.report.txt` (лежит рядом с собранным ISO) или текст из лога на вкладке «Сборка» (кнопка «Копировать лог»).
